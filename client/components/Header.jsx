...
const style = {
    ...
    buttonAccent: `bg-[#172A42] border border-[#163256] hover:border-[#234169] h-full rounded-2xl flex items-center justify-center text-[#4F90EA] whitespace-nowrap`
};
    ...
    return (
        <div className={style.wrapper}>
            ...
            <div className={style.buttonsContainer}>
                ...
                {currentAccount ? (
                    <div className={`${style.button} ${style.buttonPadding}`}>
                        <div className={`${style.buttonTextContainer} whitespace-nowrap`}>{username}</div>
                    </div>
                ) : (
                    <div
